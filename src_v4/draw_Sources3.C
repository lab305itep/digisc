...
void draw_MC(TChain *tMc, const char *name, const char *fname, TCut cXY, TCut cZ, double Efit[2])
{
	char str[256];
	double rAB;
	long NA, NB;
	...
	tMc->Project("hMc", "(SiPmCleanEnergy+PmtCleanEnergy)/2.0", cSel && cZ && cXY && cn);
	tMc->Project("hMcSiPM", "SiPmCleanEnergy", cSel && cZ && cXY && cn);
	tMc->Project("hMcPMT", "PmtCleanEnergy", cSel && cZ && cXY && cn);
...
void draw_Sources3(int iser, const char *rootdir = "root6n12", double Rndm_or_scale = 1.0, int max_files = 0)
{
	const char *name = "";
	char fname[1024];
	char str[1024];
	...
	case 1001:	// Na MC, center
		...
		tMc->AddFile(str);
		name = "22Na";
		sprintf(fname, "22Na_MC_center_%s", rootdir);
		break;
	case 1002:	// Na MC, edge
		...
		tMc->AddFile(str);
		name = "22Na";
		sprintf(fname, "22Na_MC_edge_%s", rootdir);
		break;
	case 1011:	// Na MC, center new geant
		cXY = (TCut) "(NeutronX[0] - 48) * (NeutronX[0] - 48) + (NeutronX[1] - 48) * (NeutronX[1] - 48) + (NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 400";
		cZ = (TCut) "(NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 100";
		sprintf(str, "/home/clusters/rrcmpi/alekseev/igor/%s/MC/DataTakingPeriod01/RadSourcesG4/mc_22Na_glbLY_transcode_rawProc_pedSim.root", rootdir);
		tMc->AddFile(str);
		name = "22Na";
		sprintf(fname, "22Na_MCG4_center_%s", rootdir);
		break;
	case 1012:	// Na MC, edge new geant
		cXY = (TCut) "(NeutronX[0] - 48) * (NeutronX[0] - 48) + (NeutronX[1] - 88) * (NeutronX[1] - 88) + (NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 400";
		cZ = (TCut) "(NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 100";
		sprintf(str, "/home/clusters/rrcmpi/alekseev/igor/%s/MC/DataTakingPeriod01/RadSourcesG4/mc_22Na_90cmPos_glbLY_transcode_rawProc_pedSim.root", rootdir);
		tMc->AddFile(str);
		name = "22Na";
		sprintf(fname, "22Na_MCG4_edge_%s", rootdir);
		break;
	case 1101:	// Co MC, center
		...
		tMc->AddFile(str);
		name = "60Co";
		sprintf(fname, "60Co_MC_center_%s", rootdir);
		break;
	case 1102:	// Co MC, edge
		...
		tMc->AddFile(str);
		name = "60Co";
		sprintf(fname, "60Co_MC_edge_%s", rootdir);
		break;
	case 1111:	// Co MC, center new geant
		cXY = (TCut) "(NeutronX[0] - 48) * (NeutronX[0] - 48) + (NeutronX[1] - 48) * (NeutronX[1] - 48) + (NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 400";
		cZ = (TCut) "(NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 100";
		sprintf(str, "/home/clusters/rrcmpi/alekseev/igor/%s/MC/DataTakingPeriod01/RadSourcesG4/mc_60Co_glbLY_transcode_rawProc_pedSim.root", rootdir);
		tMc->AddFile(str);
		name = "60Co";
		sprintf(fname, "60Co_MCG4_center_%s", rootdir);
		break;
	case 1112:	// Co MC, edge new geant
		cXY = (TCut) "(NeutronX[0] - 48) * (NeutronX[0] - 48) + (NeutronX[1] - 88) * (NeutronX[1] - 88) + (NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 400";
		cZ = (TCut) "(NeutronX[2] - 49.5) * (NeutronX[2] - 49.5) < 100";
		sprintf(str, "/home/clusters/rrcmpi/alekseev/igor/%s/MC/DataTakingPeriod01/RadSourcesG4/mc_60Co_90cmPos_glbLY_transcode_rawProc_pedSim.root", rootdir);
		tMc->AddFile(str);
		name = "60Co";
		sprintf(fname, "60Co_MCG4_edge_%s", rootdir);
		break;
	default:
		printf("%d - unknown\n", iser);
		...
		printf("11 - center (50, 50, 50) position, new geant\n");
		printf("12 - edge (50, 90, 50) position, new geant\n");
		code = -1;
		break;
	}
	...
	case 0:	// Experiment
		...
		break;
	case 1:	// MC
		draw_MC(tMc, name, fname, cXY, cZ, Efit);
		break;		
	default:
		break;
	}

#!/bin/bash
#PBS -N digi_spectr_200
#PBS -q mpi
#PBS -l walltime=0:30:00
#PBS -l nodes=100
#PBS -l mem=4Gb
#PBS -o /home/clusters/rrcmpi/alekseev/igor/tmp/spectr_200.out
#PBS -e /home/clusters/rrcmpi/alekseev/igor/tmp/spectr_200.err
...
mpirun --mca btl ^tcp run_spectr_mpi 100
exit 0

...
#PBS -l pmem=3Gb
#PBS -o /home/clusters/rrcmpi/alekseev/igor/tmp/MonoFH.out
#PBS -e /home/clusters/rrcmpi/alekseev/igor/tmp/MonoFH.err
cd /home/itep/alekseev/igor/MonoNu

for DIRNAME in R0.000C0.000S0.980 R0.000C0.000S1.000 R0.000C0.000S1.000_DMAX \
	R0.000C0.000S1.000_DMIN  R0.000C0.000S1.020  R0.060C0.020S1.000 ; do

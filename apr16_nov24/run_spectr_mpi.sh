...
export ZERO_ERROR_CORRECTION="0"

export OUT_DIR=/home/clusters/rrcmpi/alekseev/igor/apr16_nov24/base_10d.data
...
root -l -b -q "apr16_nov24/danss_calc_ratio_v6.C(\"${NAME}\", $SPECTR_BGSCALE)"
date
exit 0

#!/bin/bash
#PBS -N digi_spectr_1hit
#PBS -q mpi
#PBS -l walltime=0:30:00
#PBS -l nodes=323
#PBS -l pvmem=2Gb
#PBS -o /home/clusters/rrcmpi/alekseev/igor/tmp/spectr_1hit.out
#PBS -e /home/clusters/rrcmpi/alekseev/igor/tmp/spectr_1hit.err
...
export OUT_DIR=/home/clusters/rrcmpi/alekseev/igor/apr16_jan19_1hit

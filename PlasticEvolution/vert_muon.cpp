/******************************************************************************
 * Select vertical muons and make tree of energy deposit.                     *
 * Process my root files after 1st pass. Use hit information only.            *
 * Muon is required to enter top plane and exit bottom plane. Horizontal      *
 * projection of the track should be less 20 cm.                              *
 ******************************************************************************/
#include <stdio.h>
#include <TFile.h>
#include <TTree.h>
